...
def get_project_root():
    ...
    # Debug: Print the project root to verify
...
def load_config():
    ...
    # Debug: Print the config path to verify
    print(f"[DEBUG] Looking for config.yaml at: {config_path}")
...
def load_raw_data(filepath=None):
    ...
    if not os.path.exists(filepath):
        raise FileNotFoundError(
            ...
            f"Please ensure the dataset exists at: {filepath}"
        )
